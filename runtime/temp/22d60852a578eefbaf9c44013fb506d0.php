<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"E:\wamp64\www\tp5_blog\public/../application/index\view\search\search.html";i:1528081964;s:74:"E:\wamp64\www\tp5_blog\public/../application/index\view\common\header.html";i:1528082108;s:73:"E:\wamp64\www\tp5_blog\public/../application/index\view\common\right.html";i:1475987682;s:72:"E:\wamp64\www\tp5_blog\public/../application/index\view\common\foot.html";i:1474777165;}*/ ?>
...
<div class="hotmenu">
    ...
    <a href='/tp5_blog/public/index.php/index/search/index?keywords=<?php echo $vo['tagname']; ?>'><?php echo $vo['tagname']; ?></a>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
...
<div class="overall">
	...
	<div class="left">
		...
		<?php
			...
			foreach ($arr as $k=>$v) {
				echo "<a href='/tp5_blog/public/index.php/index/search/index?keywords=$v'>$v</a>";
			}
		?>
		</div>
		</div>
